...
"""
## Note: These are used to compute the actual zero-point
"""
keyw_dict = dict()
...
naming_dict["outfile_pre"] = "prefix_"      # Pre-fix for the output image start
naming_dict["out_centre"] = [234.0000, 55.0000]  # Output image centre in RA and DEC
...
sw_fixed["zpt_fin"] = 30.               # Zero-point of the final image (in AB)
sw_fixed["pix_scale"] = 0.2             # Pixel scale of the output image (in arcsec per pixel)
